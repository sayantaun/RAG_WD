...
apikey = "juVl2yahgy4bYOIllkZ2CSihE3VHjo0Rkefp6AxCaq-l"                             # os.getenv("APIKEY", None)
discovery_proj_id = "f28b7d5d-d987-435c-b4a7-6967e9dfd195"                # os.getenv("DISCOVERY_PROJECTID", None)
service_url = "https://api.us-east.discovery.watson.cloud.ibm.com/instances/78549bc8-2c7c-4151-bfae-a4c39b9843e9"                       # os.getenv("SERVICE_URL", None)
watsonx_proj_id = "370c586e-0e70-4e42-a5e1-f68ec052427e"                    # os.getenv("WATSONX_PROJECTID", None)
...
#discovery_question="What is the hotel check in and check out time?"
# discovery_question="What are the breakfast options available"
#"What is the breakfast options available?"
# print(handle_wx_wd(discovery_question))
